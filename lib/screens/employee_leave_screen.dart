...
// ---------------------------------------------------------------------------
// TAB 2: APPLY PERMISSION (Unified Logic)
// ---------------------------------------------------------------------------
          ...
          children: [
            ...
            SizedBox(
              ...
              child: ElevatedButton(
                ...
                child: _isLoading
                    ? const CircularProgressIndicator(color: Colors.white)
                    : Text('Submit Permission Request', style: GoogleFonts.poppins(fontSize: 16, fontWeight: FontWeight.w600, color: Colors.white)),
              ),
            ),
          ],
        ),
