...
class _SettingsScreenState extends State<SettingsScreen> {
  ...
  Widget _buildSectionHeader(String title) {
    return Container(
      ...
      decoration: BoxDecoration(
        color: const Color(0xFF152A4A).withValues(alpha: 0.1),
        borderRadius: BorderRadius.circular(8),
      ),
      child: Text(
        title,
  ...
  Widget _buildShiftCard(BuildContext context, Shift shift) {
    ...
    final primaryColor = isNight ? Colors.indigo : const Color(0xFF152A4A);
                        ...
                        itemBuilder: (context) => [
                          PopupMenuItem(
                            ...
                            child: Row(
                              ...
                              children: [
                                IconButton(
                                  icon: const Icon(Icons.edit_outlined, size: 22, color: Color(0xFF152A4A)),
                                  onPressed: () {
                ...
                child: Row(
                  children: [
                    Container(
                      ...
                      child: const Icon(Icons.schedule, color: Color(0xFF152A4A), size: 20),
                    ),
                    const SizedBox(width: 16),
                    Text(
                ...
                child: Form(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Container(
                        decoration: BoxDecoration(
                          color: _hasGracePeriod ? const Color(0xFF152A4A).withOpacity(0.03) : Colors.grey.shade50,
                          borderRadius: BorderRadius.circular(16),
                          border: Border.all(
                            color: _hasGracePeriod ? const Color(0xFF152A4A).withOpacity(0.2) : Colors.transparent,
                          ),
                        ),
                        padding: const EdgeInsets.all(16),
                        child: Column(
